"""
a library of special-purpose helper objects implementing ordered sets backed
by lists.  The utility of this library, and of the shared objects that derive from
it, is somewhat in doubt.  These objects predate the L{aatree} module, which
might provide faster algorithmic performance, and therefore improve the
justification for the existence of these structures.
"""
